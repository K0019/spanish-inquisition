...
#define UNIQUE_ENEMY_ENHANCEDSORCERER new EnemyRanged(&g_sLevel, &g_sEntities.m_vPellets, "Enhanced Sorcerer", "EEEE", "EEEE", c, (WORD)0x0E, 20, 3, 0.35, 0.4, 0.0, 0.2, true, 0.2, 30, 4)
