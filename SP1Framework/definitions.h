...
#define UNIQUE_ENEMY_ENHANCEDSORCERER new EnemyRanged(&g_sLevel, &g_sEntities.m_vPellets, "Enhanced Sorcerer", "EEEE", "EEEE", c, (WORD)0x0E, 20, 5, 0.35, 0.4, 0.0, 0.2, true, 0.2, 30, 4)
#define UNIQUE_ENEMY_GUARDIAN new EnemyMelee(&g_sLevel, "Guardian", "GGGG", "GGGG", c, (WORD)0x0E, 35, 4, 0.18, 0.3, 0.1, 0.3, 40, 5)
