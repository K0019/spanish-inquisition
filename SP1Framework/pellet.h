...
struct SPellet
{
	...
	bool m_bFriendly; // If pellet is shot by player or enemy
	...
	double m_dPlayerLifespan; //Pellet lifespan for players
	double m_dEnemyLifespan; //Pellet lifespan for enemies
